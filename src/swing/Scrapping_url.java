 ...
 * @author Admin
 */
public class Scrapping_url extends javax.swing.JFrame {

    /**
     * Creates new form Home
     */
    public Scrapping_url() {
        initComponents();
        setColor(btn_1); 
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Enter The Website Link");

        jTextField2.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 1, 0, new java.awt.Color(0, 153, 255)));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Scrapping_url.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Scrapping_url().setVisible(true);
            }
        });
    }
